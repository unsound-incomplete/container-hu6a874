...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-hu6a874.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-hu6a874.containers.anotherwebservice.com/
...
```
git clone git@github.com:unsound-incomplete/container-hu6a874.git
cd container-hu6a874
```
...
```
docker attach container-hu6a874
```
